...
/**
 * The downloader file. Takes a String as URL, updates with integer (0-100)
 * and the result is the path of the downloaded file
 * We will download the file unpack if neccessary and place within that rom tpes group
 * eg snes atari nes etc
 * if the folder doesnt exists for that rom section then we will create the folder with a try and catch
 * this procces will be done in a a sync tasker same as pfytv updater
 */
public class RomDownloader extends AsyncTask <String,Integer,Boolean> {
    ...
    public RomDownloader(Context ctx, FileWriter logWriter)
    {
        //context and log writer
        m_ctx = ctx;
